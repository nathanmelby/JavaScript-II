...
fullNames = runners.map(function(runner){
...
largeShirts = runners.filter(function (name) {
...
ticketPriceTotal = runners.reduce(function(accumulator, tally) {
...
biggestDonor = runners.reduce(function(wealthiest, donor) {
...
companySkinix = runners.filter(function (company) {
